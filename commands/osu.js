	...
	data: new SlashCommandBuilder()
		...
		.addSubcommand((cmd) =>
			cmd
				...
				.addStringOption((opt) => opt.setName("username").setDescription("The osu! username"))
		)
		.addSubcommand((cmd) =>
			cmd
				.setName("set")
				...
				.addStringOption((opt) =>
					opt.setName("username").setDescription("Your osu! username").setRequired(true)
				)
		),
	/**
